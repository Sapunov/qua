    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_reset_password_token', models.CharField(default=None, max_length=64, null=True, unique=True)),
                ('_reset_password_token_valid_until', models.DateTimeField(default=None, null=True)),
